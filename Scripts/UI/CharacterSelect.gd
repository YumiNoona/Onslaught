...
var characters := [
	{
		"name": "SHOOTER",
		"scene": "res://Scenes/Player/Player_Veneca.tscn",
	...
	{
		"name": "ROCKY",
		"scene": "res://Scenes/Player/Player_Rocky.tscn",
	...
	{
		"name": "SIMON",
		"scene": "res://Scenes/Player/Player_Simon.tscn",
...
func _ready() -> void:
	...
	if OS.has_feature("web"):
		...
		ResourceLoader.load_threaded_request("res://Scenes/Core/Game.tscn")
...
func _process(_delta: float) -> void:
	if not game_loaded and not OS.has_feature("web") and ResourceLoader.load_threaded_get_status("res://Scenes/Core/Game.tscn") == ResourceLoader.THREAD_LOAD_LOADED:
		game_scene = ResourceLoader.load_threaded_get("res://Scenes/Core/Game.tscn") as PackedScene
		game_loaded = true
...
func _on_select(c: Dictionary) -> void:
	...
	if game_loaded:
		...
		TransitionManager.transition_to(load("res://Scenes/Core/Game.tscn") as PackedScene, 0.3)
